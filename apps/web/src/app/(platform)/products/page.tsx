...
const title = "Products | ACE, Kernel, StorySphere, Marketplace";
const description =
  "ACE wizard, Kernel signing, StorySphere studio, and Marketplace delivery with proofs and policy guardrails.";
...
const aceStages = [
  {
    title: "Identity",
    detail: "Id, name, version, and runtime image with defaults prefilled and format validation.",
    checkpoint: "Defaults + validation"
  },
  {
    title: "Capabilities",
    detail: "Toggle generator, catalog, scheduler, liveloop, proof, moderator, monitor, or assistant.",
    checkpoint: "Preset-ready toggles"
  },
  {
    title: "Runtime & models",
    detail: "Pick triggers (cron/event/http), llmId + ttsId, publishLiveLoop metadata, and resources.",
    checkpoint: "Triggers + resources"
  },
  {
    title: "Avatar & activation",
    detail: "Activation line, avatar assets/voice url, and a preview of the activation moment.",
    checkpoint: "Activation preview"
  },
  {
    title: "Review & proof",
    detail: "Readonly manifest JSON, SHA-256 compute, SentinelNet verdict, Kernel signing + register.",
    checkpoint: "SHA-256 + verify"
  }
];
...
const manifestPreview = `{
  ...
  "name": "Atlas",
  "version": "0.1.0",
  "runtime": { "image": "ghcr.io/illuvrse/ace:latest" },
  "capabilities": ["generator", "assistant"],
  "activation": { "trigger": "event", "publishLiveLoop": true }
}`;
  ...
  return (
    <>
      ...
      <div className="space-y-10">
        <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white px-8 py-10 shadow-card">
          <div className="pointer-events-none absolute -left-24 -top-24 h-64 w-64 rounded-full bg-[radial-gradient(circle,rgba(15,118,110,0.18),transparent_70%)] blur-3xl" />
          <div className="pointer-events-none absolute -right-24 top-14 h-72 w-72 rounded-full bg-[radial-gradient(circle,rgba(245,158,11,0.2),transparent_70%)] blur-3xl" />
          <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
            <div className="space-y-5">
              ...
              <h1 className="text-4xl font-semibold leading-tight">
                Build, sign, and activate agents with proof-first defaults.
              </h1>
              <p className="text-lg text-slate-700">
                The ACE wizard assembles your manifest across Identity, Capabilities, Runtime/Models,
                Avatar/Activation, and Review. Every step feeds live JSON, SHA-256 digest, and
            ...
            <div className="flex flex-col gap-4">
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-card">
                ...
                <pre className="mt-3 overflow-auto rounded-xl bg-white p-3 text-[12px] leading-relaxed text-slate-800 shadow-sm">
{manifestPreview}
                </pre>
                <div className="mt-3 flex flex-wrap items-center justify-between gap-2 text-xs text-slate-500">
                  <span>Autosave on</span>
                  <span>SHA-256 updating</span>
                </div>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-card">
          ...
          <ol className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {aceStages.map((stage, index) => (
              ...
              >
                ...
                <p className="mt-2 text-sm text-slate-700">{stage.detail}</p>
            ...
            <Card
              ...
              body={
                <div className="space-y-2 text-sm text-slate-700">
                  <p>
                    One-click handoff writes the manifest to localStorage + cookie so Playground can
                    load it instantly.
                  </p>
                  <p>
                    Register uses Kernel sign + Agent Manager stubs so you can test the full path even
                    if backend isn’t live.
                  </p>
                  <p>Errors surface inline with severity so you know why a register is blocked.</p>
                </div>
              }
              footer={
                <div className="space-y-2">
                  <Link
                    href="/playground?source=ace"
                    className="inline-flex text-sm font-semibold text-teal-700 underline underline-offset-4"
                  >
                    Open Playground
                  </Link>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card
              ...
              body={
                <div className="space-y-3 text-sm text-slate-700">
                  <p>
                    Preview the activation line, avatar assets, and voice sample link before pushing
                    to Playground.
                  </p>
                  <p>
                    Keep assets in S3 or HTTPS; we’ll carry the URLs and voice activation text into
                    the manifest.
                  </p>
                </div>
              }
            ...
            <Card
              ...
              body={
                <div className="space-y-2 text-sm text-slate-700">
                  <p>
                    Pick triggers (cron/event/http) and opt into LiveLoop publishing so agents ship
                    with clear activation rules.
                  </p>
                  <p>
                    Runtime image + resources sit alongside capabilities so operators see what’s
