...
import { getLibraryVideos, type LibraryVideo } from "../../lib/libraryFiles";
    ...
    <div className="space-y-10">
      <section className="rounded-3xl border border-slate-700/70 bg-slate-800/70 px-8 py-10 shadow-card">
        ...
        <p className="mt-3 max-w-3xl text-lg text-slate-200/90">
          Everything available under <code>apps/storysphere/public</code> is mirrored here. Preview feature
          films, scan renders, and pull direct links for LiveLoop or downloads.
        </p>
      ...
      <PageSection eyebrow="Renders + promos" title="Every MP4 in public">
        ...
        <div className="mt-4 text-sm text-slate-200/80">
          Source: <code>apps/storysphere/public</code>. Items are sorted alphabetically and ready to wire into
          LiveLoop.
        </div>
      </PageSection>
    </div>
