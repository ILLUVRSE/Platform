...
import { SP500_BOARD } from "@/data/sp500Board";
import { COMPANY_CARDS, MARKET_CARDS } from "@/data/gameCards";
import { Card, GameState, PlayerState, PropertyState, Tile, CompanyTile } from "@/types/game";
